...
function pagelayer_recaptcha_loader(jEle, loadScript){
	...
	if(pagelayer_empty(window.grecaptcha) && !pagelayer_empty(loadScript)){
		jQuery('body').append('<script src="https://web.archive.org/web/20230506214351/https://www.google.com/recaptcha/api.js?render=explicit'+reParam+'" async defer></script>');
	}
...
function pagelayer_fb_apps(jEle){
	...
	(function(d, s, id) {
		...
		js.src = "https://web.archive.org/web/20230506214351/https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v3.0";
...
/*
     FILE ARCHIVED ON 21:43:51 May 06, 2023 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 00:21:09 May 05, 2024.
...
playback timings (ms):
  ...
  cdx.remote: 0.055
  esindex: 0.01
  LoadShardBlock: 158.607 (3)
  PetaboxLoader3.datanode: 91.812 (5)
  load_resource: 152.664
  PetaboxLoader3.resolve: 74.794
  loaddict: 52.363
*/